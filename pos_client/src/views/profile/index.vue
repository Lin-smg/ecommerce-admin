    ...
    >
      ...
      <div>
        <el-row :gutter="10" style="padding: 10px; line-height: 30px;">
          ...
          <el-col :span="1">:</el-col>
          <el-col :span="14">
            <el-input v-model="companyProfile.code" size="small" />
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10" style="padding: 10px; line-height: 30px;">
          ...
          <el-col :span="1">:</el-col>
          <el-col :span="14">
            <el-input v-model="companyProfile.name" size="small" />
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10" style="padding: 10px; line-height: 30px;">
          ...
          <el-col :span="1">:</el-col>
          <el-col :span="14">
            <el-input v-model="companyProfile.type" size="small" />
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10" style="padding: 10px; line-height: 30px;">
          ...
          <el-col :span="1">:</el-col>
          <el-col :span="14">
            <el-input v-model="companyProfile.phone" type="tel" size="small" />
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10" style="padding: 10px; line-height: 30px;">
          ...
          <el-col :span="1">:</el-col>
          <el-col :span="14">
            <el-input v-model="companyProfile.email" size="small" />
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10" style="padding: 10px; line-height: 30px;">
          ...
          <el-col :span="1">:</el-col>
          <el-col :span="14">
            <el-input v-model="companyProfile.address" type="textarea" :rows="3" size="small" />
          </el-col>
        </el-row>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button size="small" type="primary" @click="editVisible = false">Confirm</el-button>
      </span>
    </el-dialog>
...
<script>
import { Profile } from '../../mixinsFile/profile'
